...
public enum HTTPStatusCode: Int, Error, Codable {
    ...
    /// - inaccessibleDueToPendingEmailConfirmation: Server has received request and cannot process it because preconditions are not met: user did not confirm his email
    case inaccessibleDueToPendingEmailConfirmation = 452
